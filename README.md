...
```html
<link href="https://cdn.jsdelivr.net/gh/tretapey/raisincss@1.0.6/raisin.min.css" rel="stylesheet"/>
```

or import it in your css:

```css 
@import "https://cdn.jsdelivr.net/gh/tretapey/raisincss@1.0.6/raisin.min.css";
```
